...
### 2. Physical Memory Manager - NUMA / Slab (`core/kernel/src/mm/pmm/numa.c`, `core/kernel/src/mm/pmm/slab.c`)
*   **File:** `core/kernel/src/mm/pmm/numa.c`
...
### 3. ZSwap Hash Table (`core/kernel/src/mm/zswap.c`)
