...
| C2 | Interface `uapi/` move | ✅ Completed | `interface/uapi/` is authoritative; root `uapi` compatibility symlink remains temporarily for build/include compatibility. |
