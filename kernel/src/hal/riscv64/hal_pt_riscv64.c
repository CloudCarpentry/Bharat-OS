...
static void* riscv64_phys_to_virt(phys_addr_t phys) { return (void*)(phys + g_kernel_virt_offset); }
static phys_addr_t riscv64_virt_to_phys(const void* virt) { return (phys_addr_t)((uintptr_t)virt - g_kernel_virt_offset); }
