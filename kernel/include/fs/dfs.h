...
// Stream a file block directly from a remote storage node onto a local GPU (GPUDirect Storage bypass)
int dfs_rdma_to_gpu_bypass(dfs_inode_t* dfs_node, uint64_t file_offset, void* local_gpu_ptr, uint32_t size);
