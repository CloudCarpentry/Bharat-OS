...
/* Experimental v1 domains retain their values and semantics. */
...
#define BH_HMEM_DOMAIN_NUMA_LOCAL UINT32_C(5)
#define BH_HMEM_DOMAIN_NUMA_REMOTE UINT32_C(6)
#define BH_HMEM_DOMAIN_PINNED UINT32_C(7)
#define BH_HMEM_DOMAIN_DMA_VISIBLE UINT32_C(8)
#define BH_HMEM_DOMAIN_GPU_DEVICE UINT32_C(9)
#define BH_HMEM_DOMAIN_GPU_SHARED UINT32_C(10)
#define BH_HMEM_DOMAIN_NPU_DEVICE UINT32_C(11)
#define BH_HMEM_DOMAIN_NPU_SHARED UINT32_C(12)
#define BH_HMEM_DOMAIN_CXL UINT32_C(13)
#define BH_HMEM_DOMAIN_PMEM UINT32_C(14)
#define BH_HMEM_DOMAIN_HBM UINT32_C(15)
#define BH_HMEM_DOMAIN_MAX BH_HMEM_DOMAIN_HBM

/* Observable lifecycle vocabulary. Unsupported transitions fail closed. */
#define BH_HMEM_STATE_CREATED UINT32_C(0)
#define BH_HMEM_STATE_PLACED UINT32_C(1)
#define BH_HMEM_STATE_CPU_MAPPED UINT32_C(2)
#define BH_HMEM_STATE_DEVICE_REGISTERED UINT32_C(3)
#define BH_HMEM_STATE_DEVICE_RESIDENT UINT32_C(4)
#define BH_HMEM_STATE_SHARED UINT32_C(5)
#define BH_HMEM_STATE_SYNC_PENDING UINT32_C(6)
#define BH_HMEM_STATE_MIGRATING UINT32_C(7)
#define BH_HMEM_STATE_DYING UINT32_C(8)
#define BH_HMEM_STATE_DEAD UINT32_C(9)
...
#define BH_HMEM_RIGHT_CREATE (UINT64_C(1) << 8)
#define BH_HMEM_RIGHT_QUERY (UINT64_C(1) << 9)
#define BH_HMEM_RIGHT_DESTROY (UINT64_C(1) << 10)
#define BH_HMEM_RIGHT_ALL ((UINT64_C(1) << 11) - 1)
