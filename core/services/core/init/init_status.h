...
typedef enum {
    ...
    INIT_BOOT_OUTCOME_BOOTSTRAP_DEFERRED = 4,
} init_boot_outcome_t;

typedef enum {
    INIT_PHASE_RESET = 0,
    INIT_PHASE_CONTEXT_READY = 1,
    INIT_PHASE_KERNEL_HEALTH_VALIDATED = 2,
    INIT_PHASE_PROFILE_SELECTED = 3,
    INIT_PHASE_PERSONALITY_SELECTED = 4,
    INIT_PHASE_MANIFEST_SELECTED = 5,
    INIT_PHASE_GRAPH_VALIDATED = 6,
    INIT_PHASE_CORE_STARTING = 7,
    INIT_PHASE_CORE_READY = 8,
    INIT_PHASE_INFRA_STARTING = 9,
    INIT_PHASE_INFRA_READY = 10,
    INIT_PHASE_OPTIONAL_STARTING = 11,
    INIT_PHASE_HANDOFF_PREPARED = 12,
    INIT_PHASE_HANDOFF_COMPLETE = 13,
    INIT_PHASE_QUIESCENT = 14,
} init_phase_t;
